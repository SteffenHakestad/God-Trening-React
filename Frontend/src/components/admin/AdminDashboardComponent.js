    ...
    switch (btn) {
      ...
      case "Upload":
        setUploadState((prevState) => {
          const newState = prevState === "collapse" ? "expand" : "collapse";
          uploadContainer.current.style.display =
            newState === "expand" ? "none" : "block";
          return newState;
        });
        break;
    ...
    <div id="admin-dashboard">
      ...
      >
        ...
        <img
          ...
          style={{ display: publishState === "expand" ? "block" : "none" }}
        ></img>
        <img
          alt="collapse icon"
          src="/assets/icons/icon-down-arrow.svg"
          className="collapse-icon"
          style={{ display: publishState === "collapse" ? "block" : "none" }}
        ></img>
      </button>
      ...
      <button
        className="dashboard-collapse-btn"
        onClick={() => expandInfo("Upload")}
      >
        Last opp nye bilder til fremsiden
        <img
          alt="expand icon"
          src="/assets/icons/icon-right-arrow.svg"
          className="expand-icon"
          style={{ display: uploadState === "expand" ? "block" : "none" }}
        ></img>
        <img
          alt="collapse icon"
          src="/assets/icons/icon-down-arrow.svg"
          className="collapse-icon"
          style={{ display: uploadState === "collapse" ? "block" : "none" }}
        ></img>
      </button>
      <div
        className="dashboard-collapse-container"
      ...
      >
        ...
        <img
          ...
          src="/assets/icons/icon-right-arrow.svg"
          className="expand-icon"
          style={{ display: supportState === "expand" ? "block" : "none" }}
        ></img>
        <img
          alt="collapse icon"
          src="/assets/icons/icon-down-arrow.svg"
          className="collapse-icon"
          style={{ display: supportState === "collapse" ? "block" : "none" }}
        ></img>
      </button>
